...
pub struct ShaderModules<'rcx> {
    pub vert: Option<gfx2::ShaderModule<'rcx, OpenGlBackend>>,
    pub frag: Option<gfx2::ShaderModule<'rcx, OpenGlBackend>>,
    pub geom: Option<gfx2::ShaderModule<'rcx, OpenGlBackend>>,
    pub tesseval: Option<gfx2::ShaderModule<'rcx, OpenGlBackend>>,
    pub tessctl: Option<gfx2::ShaderModule<'rcx, OpenGlBackend>>,
    pub comp: Option<gfx2::ShaderModule<'rcx, OpenGlBackend>>,
}

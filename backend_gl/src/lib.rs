...
impl gfx2::traits::Swapchain for GlSwapchain {
    fn size(&self) -> (u32, u32) {
        self.inner.size()
    }
}

impl gfx2::traits::GraphicsPipeline for GlGraphicsPipeline {}
impl gfx2::traits::ShaderModule for GlShaderModule {}
impl gfx2::traits::DescriptorSetLayout for GlDescriptorSetLayout {}
impl gfx2::traits::DescriptorSet for GlDescriptorSet {}
impl gfx2::traits::Buffer for GlBuffer {
    fn size(&self) -> u64 {
        self.size as u64
    }
}
impl gfx2::traits::Image for GlImage {}
impl gfx2::traits::Framebuffer for GlFramebuffer {}

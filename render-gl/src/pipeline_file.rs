...
use autograph_render::{Arena, ShaderStageFlags, VertexInputBindingDescription};
...
pub struct ShaderModules<'rcx> {
    pub vert: Option<autograph_render::ShaderModule<'rcx, OpenGlBackend>>,
    pub frag: Option<autograph_render::ShaderModule<'rcx, OpenGlBackend>>,
    pub geom: Option<autograph_render::ShaderModule<'rcx, OpenGlBackend>>,
    pub tesseval: Option<autograph_render::ShaderModule<'rcx, OpenGlBackend>>,
    pub tessctl: Option<autograph_render::ShaderModule<'rcx, OpenGlBackend>>,
    pub comp: Option<autograph_render::ShaderModule<'rcx, OpenGlBackend>>,
}
...
impl<'rcx> PipelineDescriptionFile<'rcx> {
    #[deprecated(note = "use autograph_render-shader-macros")]

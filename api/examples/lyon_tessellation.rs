...
use std::iter;
use autograph_api::pipeline::ReflectedShader;

static BACKGROUND_VERT: ReflectedShader = include_shader!("background.vert");
static BACKGROUND_FRAG: ReflectedShader = include_shader!("background.frag");
static PATH_VERT: ReflectedShader = include_shader!("path.vert");
static PATH_FRAG: ReflectedShader = include_shader!("path.frag");
...
fn main() {
    autograph_api_test::with_test_fixture(

...
pub(super) struct PhysicalDeviceSelectionResult {
...
pub(super) fn select_physical_device(
    ...
    let (physical_device, queue_family_properties) = compatible_physical_devices
        .drain(..)
        .next()
        .expect("unable to find a compatible physical device");

...
use crate::renderer::{
    util, AliasScope, Dimensions, Filter, Format, ImageUsageFlags, MipmapsCount,
    SamplerAddressMode, SamplerDescription, SamplerMipmapMode,
};
...
pub struct Arena {
    ...
    pub framebuffers: util::SyncArena<Framebuffer>,
...
impl Arena {
    pub fn new(upload_buffer: UploadBuffer) -> Arena {
        Arena {
            swapchains: util::SyncArena::new(),
            buffers: util::SyncArena::new(),
            images: util::SyncArena::new(),
            descriptor_sets: util::SyncArena::new(),
            descriptor_set_layouts: util::SyncArena::new(),
            shader_modules: util::SyncArena::new(),
            graphics_pipelines: util::SyncArena::new(),
            framebuffers: util::SyncArena::new(),
            upload_buffer,
        }
    }
}

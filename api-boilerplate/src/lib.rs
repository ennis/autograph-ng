...
use autograph_api::*;
use autograph_api_gl::{create_instance_and_window, InstanceConfig, OpenGlBackend};
...
pub struct App {
    ...
    pub renderer: Api<OpenGlBackend>,
...
impl App {
    ...
    pub fn renderer(&self) -> &Api<OpenGlBackend> {
        &self.renderer
    }
